...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        if (! Schema::hasTable('tenant_group_permission')) {
        ...
        if (! Schema::hasTable('tenant_group_inheritances')) {
        ...
        if (! Schema::hasTable('tenant_players')) {
        ...
        if (! Schema::hasTable('tenant_player_group')) {
